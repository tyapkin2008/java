...
public class RouteCalculator
{
    ...
    public List<Station> getShortestRoute(Station from, Station to)
    {
        ...
        /*данный метод не возвращал null в случаях, если путь содержал пересадки*/
    ...
    private List<Station> getRouteWithOneConnection(Station from, Station to)
    {
        ...
        /* Как требует логика метода getShortestRoute,
        должен возвращаться либо непустой список, либо null*/
        if(route.size() == 0){
            return null;
        }
        return route;
